...
import * as strings from "DocumentsLinkAccordionWebPartStrings";
import { DocumentsLinkAccordion } from "./components/DocumentsLinkAccordion";
import { IDocumentsLinkAccordionProps } from "./components/IDocumentsLinkAccordionProps";
import {
...
import { loadTheme, MessageBarType, SpinnerSize } from "office-ui-fabric-react";
...
export interface IDocumentsLinkAccordionWebPartProps {
  title: string;
  listId: string;
  fieldName: string;
...
export default class DocumentsLinkAccordionWebPart extends BaseClientSideWebPart<IDocumentsLinkAccordionWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IDocumentsLinkAccordionProps> =
      React.createElement(DocumentsLinkAccordion, {
