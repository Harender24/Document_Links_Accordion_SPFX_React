...
import styles from "./DocumentsLinkAccordion.module.scss";
import { IDocumentsLinkAccordionProps } from "./IDocumentsLinkAccordionProps";
import { IDocumentsLinksAccordionState } from "./IDocumentsLinkAccordionState";
...
export const DocumentsLinkAccordion: React.FunctionComponent<
  IDocumentsLinkAccordionProps
> = (props: IDocumentsLinkAccordionProps) => {
